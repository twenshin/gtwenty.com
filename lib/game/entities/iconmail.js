ig.module(
    ...
    .defines(function () {
        EntityIconmail = ig.Entity.extend({
            ...
            update: function () {
                if (
                    ...
                    el.href = "mailto:realgt20@gmail.com";
                    el.click();
                    //this.state = true;
            ...
            draw: function () {
                if (!this.state) {
                    this.font.draw("E-Mail", this.pos.x - ig.game.screen.x + 8, this.pos.y - ig.game.screen.y + 16, "center");
                }
                this.parent();
            }
        });
