ig.module(
    ...
    .defines(function () {
        EntityIconcall = ig.Entity.extend({
            ...
            draw: function () {
                if (!this.state) {
                    this.font.draw("Позвонить мне", this.pos.x - ig.game.screen.x + 8, this.pos.y - ig.game.screen.y + 16, "center");
                }
                this.parent();
            }
        });
