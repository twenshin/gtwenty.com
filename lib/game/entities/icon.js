        ...
        EntityIcon = ig.Entity.extend({
            ...
            update: function () {
                if (
                    ...
                    this.state = true;
                    this.projects = ig.game.spawnEntity(EntityProjects, 20, 30, { "name": "projectsfolder" });
                }
            ...
            draw: function () {
                if (!this.state || this?.projects?.step !== 4) {
                    this.font.draw("Проекты", this.pos.x - ig.game.screen.x + 8, this.pos.y - ig.game.screen.y + 16, "center");
                }
                this.parent();
            }
        });
